<?php
// HTTP
define('HTTP_SERVER', env('PROTOCOL', 'http') . '://' . env('DOMAIN', 'localhost') . '/admin/');
define('HTTP_CATALOG',  env('PROTOCOL', 'http') . '://' . env('DOMAIN', 'localhost') . '/');

// HTTPS
define('HTTPS_SERVER', env('PROTOCOL', 'https') . '://' . env('DOMAIN', 'localhost') . '/admin/');
define('HTTPS_CATALOG',  env('PROTOCOL', 'https') . '://' . env('DOMAIN', 'localhost') . '/');

// DIR
define('DIR_APPLICATION', env('DIR_APPLICATION', '/app/opencart/admin/'));
...
define('DIR_CATALOG', env('DIR_CATALOG', '/app/opencart/catalog/'));
define('DIR_LANGUAGE', env('DIR_LANGUAGE', DIR_APPLICATION . 'language/'));
define('DIR_TEMPLATE', env('DIR_TEMPLATE', DIR_APPLICATION . 'view/template/'));
...
// OpenCart API
define('OPENCART_SERVER', env('OPENCART_SERVER', 'https://www.opencart.com/'));
define('OPENCARTFORUM_SERVER', env('OPENCARTFORUM_SERVER', 'https://opencartforum.com/'));
